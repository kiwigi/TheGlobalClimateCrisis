...
const App = () => {
    ...
    switch (window.location.pathname) {
        case '/':
            ...
            <TopicContainer topicAuth={'Keishi Excell'}topicLink = {'./Topic1'} topicTitle = {'The Impact of Race & Socioeconomic Class in the U.S.A'} topicContent = {'How individuals experience the global climate crisis and other forms of environmental adversity is heavily influences by their race and socioeconomic class. The two cases will illustrate the relationship between race & socioeconomic class and noise pollution in Chelsea, Massachusetts, and the heat in Phoenix, Arizona. '}/> 
